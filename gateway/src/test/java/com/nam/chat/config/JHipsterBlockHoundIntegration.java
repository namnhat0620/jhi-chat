...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.nam.chat.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.nam.chat.security.DomainUserDetailsService", "createSpringSecurityUser");
