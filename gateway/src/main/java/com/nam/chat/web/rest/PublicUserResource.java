...
import com.nam.chat.service.UserService;
...
public class PublicUserResource {
     ...
     */
    @GetMapping("/users")
    public Mono<ResponseEntity<Flux<User>>> getAllPublicUsers(
            UserCriteria userCriteria,
            ServerHttpRequest request,
            @org.springdoc.core.annotations.ParameterObject Pageable pageable) {
        LOG.debug("REST request to get all public User names {}", userCriteria);
        ...
        return userService
                ...
                .map(headers -> ResponseEntity.ok().headers(headers)
                        .body(userService.findByCriteria(userCriteria, pageable)));
    }
}
