...
import com.nam.chat.config.Constants;
import com.nam.chat.domain.Authority;
import com.nam.chat.domain.User;
import com.nam.chat.repository.AuthorityRepository;
import com.nam.chat.repository.UserRepository;
import com.nam.chat.security.SecurityUtils;
import com.nam.chat.service.dto.AdminUserDTO;
import com.nam.chat.service.dto.UserDTO;
...
public class UserService {
    ...
    public Mono<User> saveUser(User user, boolean forceCreate) {
        return SecurityUtils.getCurrentUserLogin()
                ...
                .flatMap(login -> {
                    ...
                    return persistedUser.flatMap(savedUser -> Flux.fromIterable(user.getAuthorities())
        ...
        return getAuthorities()
                ...
                .flatMap(existingUser -> {
                    ...
                    if (details.get("updated_at") != null) {
                        ...
                        LOG.debug("Updating user '{}' in local database", user.getLogin());
                        return updateUser(user.getFirstName(), user.getLastName(), user.getEmail(), user.getLangKey(),
                                user.getImageUrl());
                    }
                    return Mono.empty();
                })
    ...
    public Flux<User> findByCriteria(UserCriteria criteria, Pageable pageable) {
        LOG.debug("Request to get all Users by Criteria");
